...
@WebServlet("/MyBdCardList.do")
public class MyBdCardList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(vo == null) {
			...
			int cnt = service.countBdCard(memId);
			request.setAttribute("memId", memId);
			request.setAttribute("memName", memName);
			request.setAttribute("cnt", cnt);
			request.getRequestDispatcher("/view/mypage/myBdCardList.jsp").forward(request, response);
		}
	}
