...
<script src="<%=request.getContextPath() %>/js/js_hkt/h_bloodReq.js"></script>
		...
		<div id="wrapper">
			...
			<section class="main_contents">
				<div id="stockMainContainer">
					<h2>${region}혈액원 혈액공급요청</h2>

					<div id="choiceList">
						<label for="dateId">혈액원입고일: </label>
					...
					<input type="button" id="stockOn" value="수령확인 (입고등록)" data-toggle="modal"
		...
		<div class="modal" id="stockModal">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<!-- Modal body -->
					<div class="modal-body" id="stockNotList"></div>
					<!-- Modal footer -->
