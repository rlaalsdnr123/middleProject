...
<%@ include file="/view/layout/common/inc_common_head.jsp" %>
  ...
  $(function(){
   ...
   <link rel="stylesheet" href="<%=request.getContextPath() %>/css/css_jhs/ddAccept.css" />
   <script src="<%=request.getContextPath() %>/js/js_jhs/ddAccept.js"></script>
</head>
<body>
  <!--!!!TOPMENU 인클루드 시작 !!!-->
 <%
...
%>
  ...
  <!-- Asdie메뉴 -->
 <%@ include file="/view/layout/mem/inc_reserve_aside.jsp" %>   
  <!-- Asdie메뉴 끝 ..-->   
      ...
      <section class="main_contents">
        ...
        <!--다들 여기에 컨텐츠 작성해주세요-->
				<div id="pl-title">
					<h1>지정헌혈 예약</h1>
					<p>　· 의료기관이 긴급으로 요청한 지정헌혈을 예약합니다. 한개의 요청당 한명의 회원이 매칭됩니다.</p>
				</div>
		
		<div id="ddListContainer">
   ...
   <div class="modal" id="DdTrueCheck">
      <div class="modal-dialog">
         <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
               <h4 class="modal-title">기부확인</h4>
               <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <!-- Modal body -->
            <div class="modal-body" id="DdCheckList">              
            </div>
            <!-- Modal footer -->
