...
<!-- 개인 Js -->
  ...
  <link rel="icon" href="<%=request.getContextPath() %>/images/favicon/favicon.ico" type="image/x-icon">
  <link rel="shortcut icon" href="<%=request.getContextPath() %>/images/favicon/favicon.png" type="image/x-icon">
  <!--브라우저 스타일 초기화-->
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/reset-css@5.0.1/reset.min.css" />
  <!--Google Fonts - 나눔고딕-->
  <link rel="preconnect" href="https://fonts.gstatic.com" />
  ...
  <header>
    <div class="inner">
      ...
      <ul class="main-menu">
        ...
        <li class="item">
          <div class="item__name">헌혈증기부</div>
          <div class="item__contents">
            <div class="contents__menu">
              <ul class="inner">
                <li>
