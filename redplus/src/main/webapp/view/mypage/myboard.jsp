 ...
 <%@ include file="/view/layout/mem/inc_mypage_aside.jsp" %>   
  <!-- Asdie메뉴 끝 ..-->   
      ...
      <section class="main_contents">
		    <div id="pl-title">
					<h1>내가 쓴글 조회</h1>
					<p>　· 회원이 게시판에 작성한 글만 가져와 출력합니다.</p>
				</div>

        <!--다들 여기에 컨텐츠 작성해주세요-->
        <!-- $(clientId) -->
        <input type="hidden" value="${login.client_id}" id="client_id" name="client_id">
        <input type="hidden" value="${board.board_modify}" id="board_modify" name="board_modify">
